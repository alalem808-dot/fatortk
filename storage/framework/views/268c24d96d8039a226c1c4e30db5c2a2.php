    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('login')); ?>">دخول</a></li>
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="<?php echo e(route('login')); ?>">دخول</a></li>
                </ul>
            </div>
            <div class="col-md-4 mb-4">
                <h6>تواصل معنا</h6>
        ...
        <div class="text-center">
            <p class="mb-0">© <?php echo e(date('Y')); ?> فاتورتك. جميع الحقوق محفوظة</p>
        </div>
    </div>
</footer>
