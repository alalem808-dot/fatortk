...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'فاتورتك'); ?> - <?php echo e($currentTenant->company_name ?? 'فاتورتك'); ?></title>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <?php if(isset($currentTenant) && $currentTenant->logo): ?>
            <img src="<?php echo e(url('storage/' . $currentTenant->logo)); ?>" alt="logo">
        <?php elseif(\App\Models\PlatformSetting::imageUrl('platform_logo')): ?>
            <img src="<?php echo e(\App\Models\PlatformSetting::imageUrl('platform_logo')); ?>" alt="<?php echo e(\App\Models\PlatformSetting::get('platform_name','فاتورتك')); ?>">
        <?php else: ?>
            <div class="brand-icon"><i class="fas fa-file-invoice"></i></div>
        <?php endif; ?>
        <div class="brand-text">
            <h5><?php echo e(Str::limit($currentTenant->company_name ?? 'فاتورتك', 18)); ?></h5>
    ...
    <nav class="sidebar-nav">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['invoices.view','customers.view','returns.view','quick_sale.access'])): ?>
        <div class="nav-section">المبيعات</div>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quick_sale.access')): ?>
        <a href="<?php echo e(route('quick-sale.index')); ?>" class="nav-link <?php echo e(request()->routeIs('quick-sale.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('returns.index')); ?>" class="nav-link <?php echo e(request()->routeIs('returns.*') ? 'active' : ''); ?>">
            <i class="fas fa-undo nav-icon"></i> المرتجعات
        </a>
        <?php endif; ?>
        <?php endif; ?>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['purchases.view','suppliers.view'])): ?>
        <div class="nav-section">المشتريات</div>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchases.view')): ?>
        <a href="<?php echo e(route('purchases.index')); ?>" class="nav-link <?php echo e(request()->routeIs('purchases.index') || request()->routeIs('purchases.show') || request()->routeIs('purchases.create') ? 'active' : ''); ?>">
            <i class="fas fa-shopping-cart nav-icon"></i> أوامر الشراء
        </a>
        <a href="<?php echo e(route('purchase-returns.index')); ?>" class="nav-link <?php echo e(request()->routeIs('purchase-returns.*') ? 'active' : ''); ?>">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['products.view','warehouses.view','stocktaking.view','settings.view'])): ?>
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('warehouses.view')): ?>
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stocktaking.view')): ?>
        <a href="<?php echo e(route('stocktaking.index')); ?>" class="nav-link <?php echo e(request()->routeIs('stocktaking.*') ? 'active' : ''); ?>">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['reports.view_sales','reports.view_profit','reports.view_stock'])): ?>
        ...
        <a href="<?php echo e(route('reports.purchases')); ?>" class="nav-link <?php echo e(request()->routeIs('reports.purchases') ? 'active' : ''); ?>">
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reports.view_profit')): ?>
        <a href="<?php echo e(route('reports.profit')); ?>" class="nav-link <?php echo e(request()->routeIs('reports.profit') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('reports.stock')); ?>" class="nav-link <?php echo e(request()->routeIs('reports.stock') ? 'active' : ''); ?>">
            <i class="fas fa-layer-group nav-icon"></i> تقرير المخزون
        </a>
        <?php endif; ?>
        <?php endif; ?>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['users.view','settings.view'])): ?>
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            <div class="avatar"><?php echo e(Str::upper(Str::substr(auth()->user()->name, 0, 1))); ?></div>
            <div class="user-info">
                <div class="name"><?php echo e(Str::limit(auth()->user()->name, 16)); ?></div>
                <div class="role"><?php echo e(auth()->user()->role ?? 'مستخدم'); ?></div>
            </div>
        </div>
...
<div class="main-content">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div class="topbar-breadcrumb"><?php echo $__env->yieldContent('page-title'); ?></div>
        </div>
        <div class="topbar-right">
            ...
            <a href="<?php echo e(route('reports.stock')); ?>" class="topbar-badge-btn" title="<?php echo e($lowStockCount); ?> منتج منخفض المخزون">
                <i class="fas fa-bell" style="font-size:.95rem;"></i>
                <span class="badge-dot"></span>
            </a>
            <?php endif; ?>
            <div class="topbar-user d-none d-md-flex">
                <div class="t-avatar"><?php echo e(Str::upper(Str::substr(auth()->user()->name, 0, 1))); ?></div>
                <span><?php echo e(Str::limit(auth()->user()->name, 14)); ?></span>
            </div>
            <form action="<?php echo e(route('logout')); ?>" method="POST" class="m-0 d-none d-md-block">
                <?php echo csrf_field(); ?>
...
<nav class="bottom-nav">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quick_sale.access')): ?>
    <a href="<?php echo e(route('quick-sale.index')); ?>" class="<?php echo e(request()->routeIs('quick-sale.*') ? 'active' : ''); ?>">
        <i class="fas fa-bolt"></i> بيع مباشر
    </a>
    <?php endif; ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('invoices.view')): ?>
    <a href="<?php echo e(route('invoices.index')); ?>" class="<?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>">
    ...
    <form action="<?php echo e(route('logout')); ?>" method="POST" class="m-0 d-flex" style="flex:1">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp8.2\htdocs\fatortk\resources\views/layouts/app.blade.php ENDPATH**/ ?>