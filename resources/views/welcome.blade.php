...
<head>
    ...
    <title>{{ \App\Models\PlatformSetting::get('platform_name','فاتورتك') }} - نظام إدارة الأعمال الاحترافي</title>
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="#">
            @php $platformLogo = \App\Models\PlatformSetting::imageUrl('platform_logo'); @endphp
            @if($platformLogo)
                <img src="{{ $platformLogo }}" alt="{{ \App\Models\PlatformSetting::get('platform_name','فاتورتك') }}">
            @else
                <span class="brand-text"><i class="fas fa-file-invoice-dollar"></i> {{ \App\Models\PlatformSetting::get('platform_name','فاتورتك') }}</span>
            @endif
        </a>
        ...
        <div class="collapse navbar-collapse" id="nav">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank" class="nav-link btn-nav-cta">
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank" class="btn-hero-primary">
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-5">
                ...
                <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank" class="btn-hero-primary d-inline-flex">
...
<section class="pricing" id="pricing">
    <div class="container">
        ...
        <div class="price-box">
            ...
            <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank" class="btn-price mt-4">
...
<section class="cta-section">
    <div class="container" style="position:relative;z-index:2">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank" class="btn-cta">
                <i class="fab fa-whatsapp" style="color:#25D366"></i> تواصل عبر واتساب
            </a>
            <a href="{{ route('login') }}" class="btn-cta" style="background:transparent;border:2px solid rgba(255,255,255,.4);color:#fff">
                <i class="fas fa-sign-in-alt"></i> تسجيل الدخول
            </a>
        </div>
    </div>
...
<footer>
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                @php $footerLogo = \App\Models\PlatformSetting::imageUrl('platform_logo'); @endphp
                @if($footerLogo)
                    <img src="{{ $footerLogo }}" alt="{{ \App\Models\PlatformSetting::get('platform_name','فاتورتك') }}" style="max-height:36px;max-width:130px;object-fit:contain;margin-bottom:.8rem;filter:brightness(0) invert(1)">
                @else
                    <div class="footer-brand"><i class="fas fa-file-invoice-dollar text-blue-400"></i> {{ \App\Models\PlatformSetting::get('platform_name','فاتورتك') }}</div>
                @endif
                <p style="font-size:.9rem;line-height:1.7">نظام إدارة الأعمال المتكامل — فواتير، مخزون، مشتريات، وتقارير مالية لشركتك.</p>
                @if(\App\Models\PlatformSetting::get('support_email'))
                <div class="mt-2" style="font-size:.85rem">
                    <i class="fas fa-envelope me-1" style="color:var(--primary-light)"></i>
                    <a href="mailto:{{ \App\Models\PlatformSetting::get('support_email') }}">{{ \App\Models\PlatformSetting::get('support_email') }}</a>
                </div>
                @endif
                <div class="social-links">
                    <a href="#" title="Facebook"><i class="fab fa-facebook-f"></i></a>
                    <a href="#" title="Twitter"><i class="fab fa-twitter"></i></a>
                    <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank" title="WhatsApp"><i class="fab fa-whatsapp"></i></a>
            ...
            <div class="col-md-4">
                ...
                <a href="{{ \App\Models\PlatformSetting::whatsappUrl('whatsapp_subscribe_msg') }}" target="_blank"
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
            <p class="mb-0" style="font-size:.85rem">© {{ date('Y') }} {{ \App\Models\PlatformSetting::get('platform_name','فاتورتك') }}. جميع الحقوق محفوظة.</p>
