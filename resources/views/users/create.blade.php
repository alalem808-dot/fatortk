...
@section('page-title')<h6 class="mb-0 fw-bold">إضافة مستخدم جديد</h6>@endsection
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-footer bg-white border-0">
                    <button type="submit" class="btn btn-primary w-100"><i class="fas fa-save me-1"></i> إضافة المستخدم</button>
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                       ...
                                       {{ in_array($wh->id, old('warehouses', [])) ? 'checked' : '' }}>
